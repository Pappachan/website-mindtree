    ...
    <main className="oet-page">
      ...
      <section className="oet-includes-section">
        <div className="oet-includes-inner">
          ...
          <div className="oet-includes-header">
            <span className="oet-section-label" data-anim="up">What This Includes</span>
            <h2 className="oet-includes-heading" data-anim="up" data-anim-delay="110">
              Comprehensive OET Training by Mindtree
            </h2>
            <p className="oet-includes-sub" data-anim="up" data-anim-delay="220">
          ...
          <div className="oet-includes-grid">
            {includes.map((item, i) => (
              <div
                className="oet-include-card"
                key={item.title}
                data-anim="scale-up"
                data-anim-delay={i * 75}
              >
      ...
      <section className="oet-cta">
        ...
        <div className="oet-cta-inner">
          <h2 className="oet-cta-heading" data-anim="up">Ready to Start Your OET Journey?</h2>
